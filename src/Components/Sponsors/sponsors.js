...
class sponsors extends React.Component{
    state={
        ...
        current:[{sponsor:Devfolio,link:'https://devfolio.co'},{sponsor:linode,link:'https://www.linode.com/'},{sponsor:Matic,link:'https://matic.network'},{sponsor:metabrainz,link:'https://metabrainz.org/'},{sponsor:bugsee,link:'https://www.bugsee.com/'},{sponsor:balasmiq,link:'https://balsamiq.com/'},{sponsor:ubidots,link:'https://ubidots.com/'},{sponsor:stickermule,link:'http://www.stickermule.com/supports/hackonhills-2019'},{sponsor:rpabot,link:'http://rpabotpro.com/'},{sponsor:HelloIntern,link:'https://www.hellointern.com/'},{sponsor:ohcampus,link:'https://ohcampus.com/'},{sponsor:cloudsploit,link:'https://cloudsploit.com/'},{sponsor:dev,link:'https://dev.to/'},{sponsor:iconscout,link:'https://iconscout.com/'},{sponsor:fsfe,link:'https://fsfe.org/index.en.html'},{sponsor:creativeTim,link:'https://www.creative-tim.com/'},{sponsor:challengeRocket,link:'https://challengerocket.com/'},{sponsor:fold,link:'https://fold.money'}]
    }
    componentWillMount(){
